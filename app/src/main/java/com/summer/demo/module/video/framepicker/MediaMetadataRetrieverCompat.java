...
public class MediaMetadataRetrieverCompat {
    ...
    public void setDataSource(final File inputFile) throws FileNotFoundException {
     ...
     * @param headers
     */
    public void setDataSource(final String uri, final Map<String, String> headers) {

        runDynamicSetDataSource(new Runnable() {
            @Override
            public void run() {
                Map<String, String> newHeaders = headers == null ? new HashMap<String,String>() : headers;
