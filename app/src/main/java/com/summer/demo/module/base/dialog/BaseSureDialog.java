...
public class BaseSureDialog extends BaseCenterDialog {
    ...
    private DialogAfterSureListener listener;
    ...
    public static BaseSureDialog getInstance(Context context, String name, DialogAfterSureListener listener) {
        if (tipDialog != null) {
            try {
                tipDialog.cancel();
            } catch (Exception e) {
    ...
    public BaseSureDialog(Context context, String name, DialogAfterSureListener listener) {
    ...
    public BaseSureDialog(Context context, int layoutid,String name, DialogAfterSureListener listener) {
        super(context, R.style.TagFullScreenDialog);
        this.listener = listener;
        this.name = name;
    ...
    public BaseSureDialog(Context context, int name, DialogAfterSureListener listener) {
        super(context, R.style.TagFullScreenDialog);
        this.listener = listener;
