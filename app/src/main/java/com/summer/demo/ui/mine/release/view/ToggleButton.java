...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#5630EC");
    /**
     * 关闭颜色
     */
    private int offBorderColor = Color.parseColor("#DCD7EB");
    /**
     * 灰色带颜色
     */
    private int offColor = Color.parseColor("#DCD7EB");
    /**
     * 手柄颜色
     */
     ...
     * 边框颜色
     */
    private int borderColor = onColor;
    /**
     * 画笔
     */
    private Paint paint;
    ...
    public void draw(Canvas canvas) {
        ...
        if (isShowAnony) {
            ...
            paint.setTextSize(SUtils.getDimen(getContext(), R.dimen.sp_14));
            if (toggleOn) {
                textLeft = SUtils.getDip(getContext(), 14);
                textTop = SUtils.getDip(getContext(), 20);
            } else {

                textLeft = SUtils.getDip(getContext(), 39);
                textTop = SUtils.getDip(getContext(), 20);
            }

            canvas.drawText("匿名", textLeft, textTop, paint);
        }
    }
