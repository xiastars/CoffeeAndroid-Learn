...
public class DatePicker extends FrameLayout {
	...
	public DatePicker(Context context, AttributeSet attrs) {
		...
		mMonthPicker.setOnValueChangedListener((picker, oldVal, newVal) -> {
			mCalendar.set(Calendar.MONTH, newVal);
			updateDate();

		});
		mDayPicker.setOnValueChangedListener((picker, oldVal, newVal) -> {

			mCalendar.set(Calendar.DATE, newVal);
			updateDate();
		});
		mYearPicker.setOnValueChangedListener((picker, oldVal, newVal) -> {
