...
public class AcListAndGrid extends FragmentActivity implements OnItemClickListener, View.OnClickListener {
    ...
    public static List<String> getData(Context context) {
        ...
        /* 从XML里获取String数组的方法*/
        String[] group = context.getResources().getStringArray(R.array.list_titles);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                showFragment(new CommonGridViewFragment());
                break;
            case 2:
